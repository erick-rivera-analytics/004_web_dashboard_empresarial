...
- `src/components/dashboard/poscosecha-clasificacion-en-blanco-explorer.tsx`
...
- `src/lib/poscosecha-clasificacion-en-blanco-client.ts`
...
- `src/lib/poscosecha-clasificacion-en-blanco.ts`
...
- `src/app/api/poscosecha/planificacion/solver/clasificacion-en-blanco/route.ts`
...
- `GET /dashboard/poscosecha/planificacion/solver/clasificacion-en-blanco` responde `200`
- `GET /api/poscosecha/planificacion/solver/clasificacion-en-blanco` responde `200` con sesion
- `POST /api/poscosecha/planificacion/solver/clasificacion-en-blanco` responde `200` con corrida valida
