...
import {
  ...
  getDateLabel,
} from "@/lib/poscosecha-clasificacion-en-blanco-client";
import type {
...
function OrdersInputTable({
  ...
  return (
    <div className="max-h-[520px] overflow-auto rounded-[24px] border border-border/70">
  ...
  async function reloadBase() {
    ...
    try {
      const nextData = await fetchJson<PoscosechaClasificacionBootData>(
        "/api/poscosecha/planificacion/solver/clasificacion-en-blanco",
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <CardDescription className="max-w-4xl text-sm leading-relaxed">
                  Esta vista usa el maestro activo de SKU de poscosecha como fuente oficial y
