...
export function PoscosechaSkusExplorer({
  ...
  const {
    ...
    "/api/poscosecha/administrar-maestros/skus",
    skuFetcher,
    {
  ...
  async function onSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const endpoint = isEditing
        ? `/api/poscosecha/administrar-maestros/skus/${encodeURIComponent(selectedSkuId)}`
        : "/api/poscosecha/administrar-maestros/skus";
            ...
            <div className="min-w-0 space-y-2">
              ...
              <div className="space-y-2">
                ...
                <CardDescription className="max-w-4xl text-sm leading-relaxed">
                  Gestiona el catalogo de SKU de poscosecha. Cada guardado crea una nueva version
                  vigente y conserva trazabilidad SCD2 en
                  {" "}
                  <span className="font-medium text-foreground">datalakehouse_bkp_07042026.public</span>.
                </CardDescription>
              </div>
            </div>
      ...
      <div className="grid gap-4 xl:grid-cols-[0.9fr_1.1fr]">
        <Card className="starter-panel border-border/70 bg-card/84">
          <CardHeader className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="poscosecha-sku-search">Buscar SKU</Label>
              <div className="relative">
                <Search className="pointer-events-none absolute left-3 top-1/2 size-4 -translate-y-1/2 text-muted-foreground" />
                <Input
                  id="poscosecha-sku-search"
                  value={search}
