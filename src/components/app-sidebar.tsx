  ...
  return (
    <Link
      ...
      className={cn(
        ...
        active
          ? "bg-slate-900 text-slate-100 shadow-sm shadow-slate-900/40 dark:bg-slate-800"
    ...
    >
      ...
      >
        <Link
          ...
          title={starterName}
        >
          <div className="flex size-8 shrink-0 items-center justify-center rounded-lg bg-slate-900 text-slate-100 dark:bg-slate-800">
            <Logo size={16} />
          </div>
          {!collapsed ? (
